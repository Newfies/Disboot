...
function fetchBanList() {
    return new Promise((resolve, reject) => {
        https.get("https://raw.githubusercontent.com/Newfies/Disboot/refs/heads/main/bans.json", (res) => {
            let data = '';
    ...
    if (interaction.commandName === 'run') {
        if (!interaction.replied && !interaction.deferred) {
            ...
            try {
                ...
                for (const [userId, reason] of banList) {
                    try {
                    ...
                    // Wait 1500ms (1.5 seconds) between bans
                    await sleep(1500);
                }
